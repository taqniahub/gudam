...
$tmpFile = "c:\gsrstools\pscript\hdinfo.txt"
echo '' > $tmpFile
...
$msg.To.Add("nizam_mahmood@manulife.com ,bill_laskey@manulife.com,myles_macinnes@manulife.com,cpo_change_management@manulife.com")
